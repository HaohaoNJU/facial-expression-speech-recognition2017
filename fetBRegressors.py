...
#Trains models using those as features.
import pickle
import numpy as np
...
X_test, Y_test = readData(vidNamesTest, trueVal, feature = 'BT')
# X_test = X_test.reshape(X_test.shape[0], 3, row, col)
#可以读出来
...
pickle.dump(clfList, open(model_file_name + modelName+'.p', 'wb'))
