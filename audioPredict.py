#audioPredict.py
#用于训练使用音频功能的模型。音频特征使用getAudioFet来计算。
import pickle
import numpy as np
...
# fetChoice = 'AudioA'
# X_train, Y_train = readData(vidNames, trueVal, feature = fetChoice, print(Flag = True)
# X_test, Y_test = readData(vidNamesTest, trueVal, feature = fetChoice, print(Flag = True)
