# -*- coding: utf-8 -*-
"""
Created on Tue Aug 22 19:57:01 2017

@author: 浩浩
"""
from audio2frames import*
import numpy 
from audio2frames import audio2frame
from audio2frames import pre_emphasis
from audio2frames import spectrum_power
from scipy.fftpack import dct 
import scipy.io.wavfile as wav
#首先，为了适配版本3.x，需要调整range的使用，因为对于版本2.x只能使用range，需要将xrange替换为range
...
def get_filter_banks(filters_num=20,NFFT=512,samplerate=16000,low_freq=0,high_freq=None):
    ...
    fbank=numpy.zeros([int(filters_num),int(NFFT/2+1)])
...
def lifter(cepstra,L=22):
    ...
    if L>0:
        ...
        return cepstra
#####################
(rate,sig) = wav.read("E:/Video_for_test/test/test.wav")
